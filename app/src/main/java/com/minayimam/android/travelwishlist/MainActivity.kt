...
class MainActivity : AppCompatActivity(), OnListItemClickedListener, OnDataChangedListener {
    ...
    private fun addNewPlace() {
        ...
        if (name.isEmpty()) {
            Toast.makeText(this, getString(R.string.enter_place_name), Toast.LENGTH_SHORT).show()
        }else if (reason.isEmpty()) {
            Toast.makeText(this, getString(R.string.enter_reason), Toast.LENGTH_SHORT).show()
        }else {
    ...
    override fun onListItemClicked(place: Place) {
        Toast.makeText(this, getString(R.string.showing_map_message), Toast.LENGTH_SHORT).show()
    ...
    override fun onListItemDeleted(position: Int) {
        ...
        Snackbar.make(findViewById(R.id.wishlist_container), getString(R.string.place_deleted, deletedPlace.name), Snackbar.LENGTH_LONG)
            .setActionTextColor(resources.getColor(R.color.pink))
